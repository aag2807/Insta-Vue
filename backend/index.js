...
admin.initializeApp({
  ...
  storageBucket: "insta-vue1.appspot.com"
});
...
app.post("/createPost", (req, res) => {
  ...
  busboy.on("finish", function() {
    ...
    function createDocument(uploadedFile){
      ...
      .then(() => {
        res.send("post added successfully " + fields.id)
      });
    }
  });
